  ...
  <Tab title="PostgreSQL">
    <Steps>
      ...
      <Step title="Create the monitoring user">
        ...
        `pg_monitor` gives the OTel agent read access to PostgreSQL monitoring views. `pg_read_all_stats` lets the receiver read `queryid` and statement statistics for statements run by other roles.
      </Step>
